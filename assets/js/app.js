...
const sttaddr = "0x28D0c016b79B9FF02C2bE111875B4Cd3316E99D5";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x28D0c016b79B9FF02C2bE111875B4Cd3316E99D5";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://muunited.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x28D0c016b79B9FF02C2bE111875B4Cd3316E99D5',
                    'symbol': 'MU',
                    'decimals': '18',
                    'image': 'https://muunited.net/images/logo.png',
                },
            },
